    ...
    <div id="content">
      <div class="content-wrapper">
        <div class="container-fluid">
                ...
                $.ajax({
                  ...
                  success: function (response) {
                    if (response == 'success') {
                      ...
                      alert("Pending Request marked as Read.");
                    } else {
          ...
          $offset = ($page - 1) * $limit;
          $count = $offset + 1;
          $sql = "SELECT contact_query.*, query_stat.query_type 
          FROM contact_query 
          LEFT JOIN query_stat ON contact_query.query_status = query_stat.id 
          LIMIT {$offset}, {$limit}";
                  ...
                  while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                      ...
                      <?php if ($row['query_status'] == 1) { ?>
                        <td><?php echo $row['query_type']; ?></td> <!-- Displays "Read" -->
                      <?php } else { ?>
                        <td><a href="query.php?id=<?php echo $row['query_id']; ?>" onclick="clickme()">
                            <b id="demo"><?php echo $row['query_type']; ?></b></a></td> <!-- Displays "Pending" as a link -->
                      <?php } ?>

                      <td id="he" style="width:100px">
                        <a style="background-color:aqua" href='delete_query.php?id=<?php echo $row['query_id']; ?>'> Delete
                        </a>
                      </td>
                    </tr>
                  <?php } ?>
