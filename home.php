        ...
        <div class="container">
            <div id="content-wrap" style="padding-bottom:75px;">
                ...
                <div class="card-container">
                    <h1 class="card-container-header">Welcome to the Hemocare</h1>
                ...
                <div class="donors">
                    ...
                    <div class="all-donors">
                        <?php
                        include 'conn.php';
                        $sql = "select * from donor_details join blood where donor_details.donor_blood=blood.blood_id order by rand() limit 10";
                        $result = mysqli_query($conn, $sql);
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ?>
